...
//altufm_parallel ACCESS_MODE="READ_ONLY" CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="MAX V" ERASE_TIME=500000000 OSC_FREQUENCY=180000 PROGRAM_TIME=1600000 WIDTH_ADDRESS=9 WIDTH_DATA=16 WIDTH_UFM_ADDRESS=9 addr data_valid dataout nbusy nread
...
module  altufm_altufm_parallel_srk
	( 
	addr,
	data_valid,
	dataout,
	...
	assign
		...
		Z_var = (X_var | Y_var);
endmodule //altufm_altufm_parallel_srk
//VALID FILE
...
module altufm (
	...
	altufm_altufm_parallel_srk	altufm_altufm_parallel_srk_component (
				.nread (nread),
				.addr (addr),
				.dataout (sub_wire0),
	 ...
	 clearbox_defparam = "access_mode=READ_ONLY;erase_time=500000000;intended_device_family=MAX V;lpm_file=UNUSED;lpm_hint=UNUSED;lpm_type=altufm_parallel;osc_frequency=180000;program_time=1600000;width_address=9;width_data=16;width_ufm_address=9;" */;
